...
#           new_job_data = WorkerCreateHoverCraftsForNewStreamerFriends.work_data streamer, ids
...
#   let (:work_data)        { WorkerDetectNewStreamerFriends.work_data streamer }
...
#       next_job_data = WorkerDetectNewStreamerFriends.work_data streamer, next_cursor_page
...
#       new_job_data = WorkerCreateHoverCraftsForNewStreamerFriends.work_data streamer, new_friend_ids
#       WorkerCreateHoverCraftsForNewStreamerFriends.should_receive(:schedule).with new_job_data
#       subject.perform work_data
#     end
#   end
